package com.jpb.android.dynamicpill.smartedge.services;
...
public class UpdaterService extends Service {
    ...
    public void onCreate() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, baseUrl + "repos/jpb.android.dynamicpill/smart-edge/releases",
                null, response -> {
