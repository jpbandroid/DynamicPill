package com.jpb.android.dynamicpill.smartedge.activities;
...
import com.jpb.android.dynamicpill.smartedge.BuildConfig;
import com.jpb.android.dynamicpill.smartedge.R;
import com.jpb.android.dynamicpill.smartedge.plugins.ExportedPlugins;
import com.jpb.android.dynamicpill.smartedge.services.UpdaterService;
import com.jpb.android.dynamicpill.smartedge.utils.adapters.RecylerViewSettingsAdapter;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        enable_btn.setOnClickListener(l -> {
            ...
            Toast.makeText(this, "Installed Apps -> DynamicPill", Toast.LENGTH_SHORT).show();
        });
    ...
    private void sendCrashNotification() {
        ...
        Notification notification = notificationBuilder.setOngoing(false)
                .setContentTitle("DynamicPill Crashed")
